...
CREATE INDEX IDX_CDC_MISURE_1 ON CDC_MISURE(IDGALVANICA);
  ...
  CREATE TABLE "CDC_SPESSORE" 
   (	"IDSPESSORE" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY , 
	"PARTE" VARCHAR2(6 BYTE) NOT NULL ENABLE, 
	"COLORE" VARCHAR2(5 BYTE) NOT NULL ENABLE, 
	"SEQUENZA" NUMBER NOT NULL ENABLE, 
	"ETICHETTA" VARCHAR2(5 BYTE) NOT NULL ENABLE, 
	"MASSIMO" NUMBER NOT NULL ENABLE, 
	"MINIMO" NUMBER NOT NULL ENABLE, 
	"DENOMINATORE" NUMBER NOT NULL ENABLE, 
	 CONSTRAINT "PK_IDSPESSORE" PRIMARY KEY ("IDSPESSORE")  
   ) ;
   


CREATE INDEX IDX_CDC_SPESSORE_1 ON CDC_SPESSORE(PARTE,COLORE);
  ...
  CREATE TABLE "CDC_APPLICAZIONE" 
   (	"IDAPPLICAZIONE" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY , 
	"PARTE" VARCHAR2(6 BYTE) NOT NULL ENABLE, 
	"COLORE" VARCHAR2(5 BYTE) NOT NULL ENABLE, 
	"APPLICAZIONE" VARCHAR2(50 BYTE) NOT NULL ENABLE, 
	"NUMEROCAMPIONI" NUMBER NOT NULL ENABLE, 
	"SPESSORE" VARCHAR2(10 BYTE) NULL , 
	 CONSTRAINT "PK_IDAPPLICAZIONE" PRIMARY KEY ("IDAPPLICAZIONE")
);

  CREATE UNIQUE INDEX "IDX_CDC_APPLICAZIONE_1" ON "CDC_APPLICAZIONE" ("COLORE", "PARTE") ;
...
CREATE TABLE CDC_ETICHETTE_DETTAGLIO
(
  IDCDCETT NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
  PREFISSO VARCHAR2(7) NOT NULL,
  PARTE VARCHAR2(6) NOT NULL,
  COLORE VARCHAR2(5) NOT NULL,
  LINEA varchar2(5) not NULL,
  DESCRIZIONE VARCHAR2(50) NOT NULL,
   CONSTRAINT PK_IDCDCETT PRIMARY KEY (IDCDCETT)
);

CREATE UNIQUE INDEX IDX_CDC_ETICHETTE ON CDC_ETICHETTE_DETTAGLIO (PREFISSO, PARTE,COLORE);