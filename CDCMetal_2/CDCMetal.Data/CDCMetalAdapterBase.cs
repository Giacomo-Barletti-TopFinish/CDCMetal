...
{
    public class CDCMetalAdapterBase : AdapterBase
    {
        public CDCMetalAdapterBase(IDbConnection connection, IDbTransaction transaction) :
        ...
        public long GetSQLID()
        {
            ...
            using (DbCommand cmd = BuildCommand("INSERT INTO _IDS (Text) Values ('aaa')"))
            {
