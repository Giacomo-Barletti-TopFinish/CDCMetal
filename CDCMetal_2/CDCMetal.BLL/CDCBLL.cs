...
namespace CDCMetal.BLL
{
    public class CDCBLL
    {
        public void CaricaEnti(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.FillCDC_ENTI(ds);
            }
        }
        ...
        public void CaricaColori(CDCDS ds, string colore)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.FillCDC_COLORI(ds, colore);
            }
        }
        public void CaricaArticoli(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.FillCDC_ARTICOLI(ds);
            }
        }
        public void CaricaArticoliDimensioni(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.FillCDC_ARTICOLI_DIMENSIONI(ds);
            }
        }
        public void CaricaArticoliSpessori(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.FillCDC_ARTICOLI_SPESSORI(ds);
            }
        }
        public void CaricaNumeroCampioni(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.FillCDC_NUMEROCAMPIONI(ds);
            }
        }
        ...
        //OLD
        public List<DataCollaudoSingle> LeggiDateCollaudoSingle()
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                return bCDCMetal.LeggiDateRiferimentoSingle();
            }
        }
        public List<BrandCollaudoSingle> LeggiBrandCollaudoSingle(string datacollaudo)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                return bCDCMetal.LeggiBrandRiferimentoSingle(datacollaudo);
            }
        }
        public List<ColoreSingle> LeggiColoreSingle()
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                return bCDCMetal.LeggiColoreRiferimentoSingle();
            }
        }
        ...
        public void LeggiCollaudoDaDataSTR(CDCDS ds, DataCollaudoSTR dataSelezionata)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.FillCDC_DATA_BRAND(ds, dataSelezionata);
            }
        }
        ...
        public void LeggiCollaudoDaDataConDescrizioneSTR(CDCDS ds, DataCollaudoSTR dataSelezionata)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.FillCDC_CON_DESCRIZIONE_STR(ds, dataSelezionata.Data, dataSelezionata.Brand);
            }
        }
        ...
        public void SalvaDatiBrands(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.UpdateBrands(ds);
            }
        }
        public void SalvaDatiEnti(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.UpdateEnti(ds);
            }
        }
        public void SalvaDatiArticoli(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.UpdateArticoli(ds);
            }
        }
        public void SalvaDatiArticoli_Dimensioni(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.UpdateArticoli_Dimensioni(ds);
            }
        }
        public void SalvaDatiArticoli_Spessori(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.UpdateArticoli_Spessori(ds);
            }
        }
        public void SalvaDatiColori(CDCDS ds)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                bCDCMetal.UpdateColori(ds);
            }
        }
        ...
        public string CreaPDFConformita(List<decimal> idPerPDF, CDCDS ds, string pathCollaudo, byte[] image, string utente)
        {
            ...
            foreach (decimal IDDETTAGLIO in idPerPDF)
            {
                ...
                if (conformita == null)
                    throw new Exception("CDC_CONFORMITA riga non trovata per IDDETTAGLIO" + IDDETTAGLIO.ToString());
                ...
                if (pdf == null)
                {
                    ...
                    pdf.IDCDCPDF = 0;
                    pdf.UTENTE = utente;
                    pdf.DATAINSERIMENTO = DateTime.Now;
        ...
        public string CreaPDFAntiallergico(List<decimal> idPerPDF, CDCDS ds, string pathCollaudo, byte[] image, bool CopiaReferto, string pathCartellaReferto)
        {
            ...
            foreach (decimal IDDETTAGLIO in idPerPDF)
            {
                ...
                List<CDCDS.CDC_ANTIALLERGICORow> antiallergico = ds.CDC_ANTIALLERGICO.Where(x => x.IDDETTAGLIO == IDDETTAGLIO).OrderBy(x => x.SEQUENZA).ToList();
                if (antiallergico.Count == 0)
                    throw new Exception("CDC_ANTIALLERGICO riga non trovato per IDDETTAGLIO" + IDDETTAGLIO.ToString());
                ...
                List<ArticoloAntiallergico> articoli = new List<ArticoloAntiallergico>();

                foreach (CDCDS.CDC_ANTIALLERGICORow art in antiallergico)
                {
                    ArticoloAntiallergico artanti = new ArticoloAntiallergico()
                    {
                        Sequenza = art.SEQUENZA,
                        Descrizione = art.DESCRIZIONE,
                        ColoreComponente = art.COLORECOMPONENTE,
                        DataProduzione = art.DATAPRODUZIONE.ToShortDateString(),
                        nichelfree = art.NICHELFREE == "S" ? true : false
                    };
                    articoli.Add(artanti);
                }
                ...
                //string certificazione = "Nichel Free-Antiallergico";
                // string fileName = string.Format("Certificazione {0} {1}.pdf", certificazione, articolo);

                string certificazione = "Antiallergico";
                string fileName = string.Format("{0}-{1}.pdf", certificazione, articolo);
                ...
                CreaCDCAntiallergico(path, IDDETTAGLIO, dettaglio.PREFISSO, dettaglio.PARTE, dettaglio.COLORE, dettaglio.COMMESSAORDINE, dettaglio.QUANTITA.ToString(), articoli, image);
                ...
                CDCDS.CDC_PDFRow pdf = ds.CDC_PDF.Where(x => x.IDDETTAGLIO == IDDETTAGLIO && x.TIPO == CDCTipoPDF.CERTIFICATOANTIALLERGICO).FirstOrDefault();
                if (pdf == null)
                {
                    pdf = ds.CDC_PDF.NewCDC_PDFRow();
        ...
        public string CreaPDFVerniceCoprente(List<decimal> idPerPDF, CDCDS ds, string pathCollaudo, byte[] image, bool CopiaReferto, string pathCartellaReferto)
        {
            ...
            foreach (decimal IDDETTAGLIO in idPerPDF)
            {
                List<CDCDS.CDC_VERNICICOPRENTIRow> vCoprente = ds.CDC_VERNICICOPRENTI.Where(x => x.IDDETTAGLIO == IDDETTAGLIO).OrderBy(x => x.SEQUENZA).ToList();
                if (vCoprente.Count == 0)
                    throw new Exception("CDC_VERNICICOPRENTI riga non trovata per IDDETTAGLIO" + IDDETTAGLIO.ToString());
                ...
                List<ArticoloVerniciCoprenti> articoli = new List<ArticoloVerniciCoprenti>();

                foreach (CDCDS.CDC_VERNICICOPRENTIRow art in vCoprente)
                {
                    ArticoloVerniciCoprenti artanti = new ArticoloVerniciCoprenti()
                    {
                        Sequenza = art.SEQUENZA,
                        Descrizione = art.DESCRIZIONE,
                        ColoreComponente = art.COLORECOMPONENTE,
                        FORNITORE = art.FORNITORE,
                        NUMEROCAMPIONI = art.NUMEROCAMPIONI,
                        TURBULA = art.TURBULA == "S" ? true : false,
                        QUADRETTATURA = art.QUADRETTATURA == "S" ? true : false,
                        DATATEST = art.DATATEST.ToShortDateString()
                    };
                    articoli.Add(artanti);
                }
              ...
              //  CreaReportVerniciCoprenti(path, turbula, quadrettatura, vCoprente.DATATEST.ToShortDateString(), dettaglio.PARTE, dettaglio.COLORE, vCoprente.FORNITORE, vCoprente.NUMEROCAMPIONI.ToString(), image);
                CreaReportVerniciCoprenti(path, IDDETTAGLIO, dettaglio.PARTE, dettaglio.COLORE, articoli, image);
                ...
                CDCDS.CDC_PDFRow pdf = ds.CDC_PDF.Where(x => x.IDDETTAGLIO == IDDETTAGLIO && x.TIPO == CDCTipoPDF.CERTIFICATOVERNICECOPRENTE).FirstOrDefault();
                if (pdf == null)
                {
                    pdf = ds.CDC_PDF.NewCDC_PDFRow();
        ...
        public string CreaPDFTenutaAcidoNitrico(List<decimal> idPerPDF, CDCDS ds, string pathCollaudo, byte[] image, bool CopiaReferto, string pathCartellaReferto)
        {
            ...
            foreach (decimal IDDETTAGLIO in idPerPDF)
            {
                ...
                List<CDCDS.CDC_TENUTACIDONITRICORow> tenuta = ds.CDC_TENUTACIDONITRICO.Where(x => x.IDDETTAGLIO == IDDETTAGLIO).OrderBy(x => x.SEQUENZA).ToList();
                if (tenuta.Count == 0)
                    throw new Exception("CDC_TENUTACIDONITRICO riga non trovata per IDDETTAGLIO" + IDDETTAGLIO.ToString());
                ...
                List<ArticoloTenutaAcidoNitrico> articoli = new List<ArticoloTenutaAcidoNitrico>();

                foreach (CDCDS.CDC_TENUTACIDONITRICORow art in tenuta)
                {
                    string bolla = art.IsBOLLANull() ? string.Empty : art.BOLLA;
                    string dataDDT = art.IsDATADDTNull() ? string.Empty : art.DATADDT.ToShortDateString();

                    ArticoloTenutaAcidoNitrico artanti = new ArticoloTenutaAcidoNitrico()
                    {
                        Sequenza = art.SEQUENZA,
                        Descrizione = art.DESCRIZIONE,
                        ColoreComponente = art.COLORECOMPONENTE,
              ...
              //  bool esito = tenuta.ESITO == "S" ? true : false;
                ...
                CreaReportTenutaAcidoNitrico(path, IDDETTAGLIO, dettaglio.PARTE, dettaglio.COLORE, articoli, image);
                ...
                CDCDS.CDC_PDFRow pdf = ds.CDC_PDF.Where(x => x.IDDETTAGLIO == IDDETTAGLIO && x.TIPO == CDCTipoPDF.CERTIFICATOTENUTAACIDONITRICO).FirstOrDefault();
                if (pdf == null)
                {
                    pdf = ds.CDC_PDF.NewCDC_PDFRow();
        ...
        public string CreaPDFColore(List<decimal> idPerPDF, CDCDS ds, string pathCollaudo, byte[] image, bool CopiaReferto, string pathCartellaReferto)
        {
            ...
            foreach (decimal IDDETTAGLIO in idPerPDF)
            {
                ...
                if (colore == null)
                    throw new Exception("CDC_COLORE riga non trovata per IDDETTAGLIO" + IDDETTAGLIO.ToString());
                ...
                List<ArticoloColore> articoli = new List<ArticoloColore>();
                ...
                {
                    ArticoloColore a = new ArticoloColore()
                    {
                        Sequenza = coloreRow.SEQUENZA,
                        Descrizione = coloreRow.DESCRIZIONE,
                        ColoreComponente = coloreRow.COLORECOMPONENTE
                    };
                    ArticoloColore artfind = articoli.Find(x => x.Sequenza == coloreRow.SEQUENZA);
                    if (artfind == null)
                    { articoli.Add(a); }
                ...
                CreaReportColorimetrico(path, data, dataCalibrazione, dettaglio.PREFISSO, dettaglio.PARTE, dettaglio.COLORE, dettaglio.COMMESSAORDINE, dettaglio.QUANTITA.ToString(), operatore, strumento, nota, articoli, misure, image);
        ...
        public string CreaPDFSpessore_new(decimal IDDETTAGLIO, string tipoCertificato, CDCDS ds, string pathCollaudo, byte[] iLoghi, byte[] iBowman, bool CopiaReferto, string pathCartellaReferto,
                  System.Data.DataTable dtAggr, string Brand, string numeroCampioni)
        {
            string fileCreato = string.Empty;
            ...
            {
                case CDCBrands.Gucci:
                    CreaReportSpessoriGucci_new(IDDETTAGLIO, tipoCertificato, ds, dtAggr,  path, dt, commessaPerStampa, operatore, galvanica.SPESSORE, galvanica.APPLICAZIONE, galvanica.STRUMENTO,   iLoghi, iBowman);
                    break;
                case CDCBrands.Balenciaga:
                case CDCBrands.McQueen:
                case CDCBrands.YSL:
                    CreaReportSpessoriYSL_new( IDDETTAGLIO,  tipoCertificato,  ds, dtAggr, path, dt, numeroCampioni, dettaglio.PARTE, dettaglio.COLORE, iLoghi);
                    break;
            }
       ...
       string prefisso, string parte, string colore, string operatore,
        ...
        {
            PDFHelper pdfHelper = new PDFHelper();
            pdfHelper.CreaReportDimensionale(data, prefisso, parte, colore, operatore, commessa, iloghi, firma, articoli, misure);
        ...
        //    pdfHelper.SalvaPdf(filename);
        //}
        private static void CreaCDCAntiallergico(string filename, decimal iddettaglio, string prefisso, string parte, string colore, string commessa, string quantita, List<ArticoloAntiallergico> antiallergico, byte[] iloghi)
        {
            PDFHelper pdfHelper = new PDFHelper();      
            pdfHelper.CreaReportAntiallergico(iddettaglio, prefisso, parte, colore, commessa, quantita, antiallergico, iloghi);
            pdfHelper.SalvaPdf(filename);
        }
        ...
        //    pdfHelper.SalvaPdf(filename);
        //}
        private static void CreaReportVerniciCoprenti(string filename, decimal iddettaglio, string parte, string colore, List<ArticoloVerniciCoprenti> vCoprente, byte[] iloghi)
        {
            PDFHelper pdfHelper = new PDFHelper();
            pdfHelper.CreaReportVerniciCoprenti(iddettaglio, parte, colore, vCoprente, iloghi);
        ...
        //    pdfHelper.SalvaPdf(filename);
        //}
        private static void CreaReportTenutaAcidoNitrico(string filename, decimal iddettaglio, string parte, string colore, List<ArticoloTenutaAcidoNitrico> arttenuta, byte[] iloghi)
        {
            PDFHelper pdfHelper = new PDFHelper();          
            pdfHelper.CreaReportTenutaAcidoNitrico(iddettaglio, parte, colore, arttenuta, iloghi);
...
string strumentoMisura, string nota, List<ArticoloColore> articoli, List<MisuraColore> misure, byte[] iloghi)
        {
            PDFHelper pdfHelper = new PDFHelper();
            pdfHelper.CreaReportColorimetrico(dataCollaudo, dataCalibrazione, prefisso, parte, colore, commessa, quantita, operatore, strumentoMisura, nota, articoli, misure, iloghi);
        ...
        private static void CreaReportSpessoriGucci_new(decimal IDDETTAGLIO, string tipoCertificato, CDCDS ds, System.Data.DataTable dtAggr, string filename, DateTime data, string commessa, string operatore, string spessoreRichiesto, string applicazione, string strumentoMisura, 
             byte[] iloghi, byte[] iBowman)
        {
            PDFHelper pdfHelper = new PDFHelper();
            pdfHelper.CreaReportSpessoriGucci_new(IDDETTAGLIO,  tipoCertificato,  ds,  dtAggr, data, commessa, operatore, spessoreRichiesto, applicazione, strumentoMisura,  iloghi, iBowman);
        ...
        private static void CreaReportSpessoriYSL_new(decimal IDDETTAGLIO, string tipoCertificato, CDCDS ds, System.Data.DataTable dtAggr ,string filename, DateTime data, string numeroCampioni, string parte, string colore, 
          byte[] iloghi)
        {
            PDFHelper pdfHelper = new PDFHelper();
            pdfHelper.CreaReportSpessoriYSL_new(IDDETTAGLIO, tipoCertificato, ds, dtAggr, data,  parte, colore, iloghi);

            pdfHelper.SalvaPdf(filename);
        }
       

        public string CreaPDFDimensionale(decimal IDDETTAGLIO, CDCDS ds, string operatore, string pathCollaudo, byte[] iFirma, byte[] iLoghi, string utente)
        {
            ...
            List<ArticoloDimensionale> articoli = new List<ArticoloDimensionale>();
            foreach (CDCDS.CDC_DIMEMSIONIRow dimensione in dimensioni)
            {
                ArticoloDimensionale artdim = new ArticoloDimensionale()
                {
                    Sequenza = dimensione.SEQUENZA,
                    Descrizione = dimensione.DESCRIZIONE
                };
                ArticoloDimensionale artfind = articoli.Find(x => x.Sequenza == dimensione.SEQUENZA);
                if (artfind == null)
                { articoli.Add(artdim); }
            ...
            CreaCDCDimensionale(path, dettaglio.DATACOLLAUDO, dettaglio.PREFISSO, dettaglio.PARTE, dettaglio.COLORE, operatore, dettaglio.COMMESSAORDINE, iLoghi, iFirma, articoli, misure);
        ...
        public decimal InserisciCDCGalvanica(CDCDS ds, string spessore, decimal IDDETTAGLIO, string applicazione, string strumentoMisura, int misurePreCampione, string utente, string tipoCertificato)
        {
            using (CDCMetalBusiness bCDCMetal = new CDCMetalBusiness())
            {
                ...
                if (galvanica == null)
                {
                   ...
                   // galvanica.IDGALVANICA = (decimal)bCDCMetal.GetID(); //- 1; //(((decimal)bCDCMetal.GetLastIdentity(); //.GetID();
                ...
                //  ds.CDC_GALVANICA.AcceptChanges();

                using (CDCMetalBusiness bCDCMetalBusiness = new CDCMetalBusiness())
                    bCDCMetalBusiness.UpdateCDC_GALVANICA(ds);
                ds.CDC_GALVANICA.AcceptChanges();

                //List<decimal> IDDETTAGLIO_List = ds.CDC_DETTAGLIO.Select(x => x.IDDETTAGLIO).Where(x => x.IDDETTAGLIO == IDDETTAGLIO).Distinct().ToList();

                var list = new List<decimal>();
                list.Add(IDDETTAGLIO);

                FillCDC_GALVANICA(ds, list, tipoCertificato);
                CDCDS.CDC_GALVANICARow galvanica2 = ds.CDC_GALVANICA.Where(x => x.IDDETTAGLIO == IDDETTAGLIO).FirstOrDefault();
                return galvanica2.IDGALVANICA;
            }
        }
