...
namespace CDCMetal
{
    public partial class CreaColorimetricoFrm : BaseChildForm
    {
        ...
        private void btnLeggiDati_Click(object sender, EventArgs e)
        {
            ...
            CreaDsPerColorimetrico(dataSelezionata);
        ...
        private void btnCreaPDF_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                fileCreati = bll.CreaPDFColore(idPerPDF, Contesto.DS, Contesto.PathCollaudo, image, chkCopiaFileReferti.Checked, Contesto.PathRefertiLaboratorio);
